...
//func (svr *Server) RegHandleFunc(cmd CMDId, f MsgFunc) {
//	svr.RegHandle(cmd, MsgHandle(f))
//}

//func (svr *Server) RegHandle(cmd CMDId, handle MsgHandle) {
//	svr.maplock.Lock()
...
//func (svr *Server) Handle(cn *Connector, msg *PduMsg) error {
...
func (svr *Server) UnknownMsgHandle(cn *Connector, msg *PduMsg) error {
	//cn.ReplyfromMsg(msg.Header, KNOWN_MSG_TYPE, PduBody{})
	return ERROR_NOFINDHANDLE
}

func (svr *Server) UnknownRespMsgHandle(cn *Connector, msg *PduMsg) error {
	return nil
}
