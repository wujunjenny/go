...
func (cli *Client) Handle(cn *Connector, msg *SmppMsg) error {
...
func (cl *Client) UnknownMsgHandle(cn *Connector, msg *SmppMsg) error {

	cn.ReplyfromMsg(msg.Header, KNOWN_MSG_TYPE, SmppBody{})
	return nil
}

func (cl *Client) UnknownRespMsgHandle(cn *Connector, msg *SmppMsg) error {
	return nil
}
